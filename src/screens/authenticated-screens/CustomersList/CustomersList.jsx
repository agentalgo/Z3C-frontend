...
const sampleCustomers = [
  {
    firstName: 'Ahmed',
    lastName: 'Al-Saud',
    companyProfile: 'Fl3xx',
    referenceNo: 'REF-001',
    arabicName: 'أحمد السعود',
    registeredName: 'Ahmed Al-Saud Trading Co.',
    email: 'ahmed@alsaudtrading.sa',
    phone: '+966 11 234 5678',
    customerVat: '300012345600003',
  ...
  },
  {
    ...
    companyProfile: 'FB01',
    referenceNo: 'REF-002',
    arabicName: 'فاطمة الزهراني',
    registeredName: 'Fatima Al-Zahrani Logistics LLC',
    email: 'fatima@zahranilogistics.sa',
    phone: '+966 12 345 6789',
    customerVat: '300098765400003',
  ...
  },
  {
    ...
    registeredName: 'Mohammed Al-Rashid Industries',
    email: 'mohammed@rashidindustries.sa',
    phone: '+966 13 456 7890',
    customerVat: '300045678900003',
  ...
  },
  {
    ...
    companyProfile: 'SM03',
    referenceNo: 'REF-004',
    arabicName: 'سارة المطيري',
    registeredName: 'Sarah Al-Mutairi Solutions',
    email: 'sarah@mutairisolutions.sa',
    phone: '+966 11 567 8901',
    customerVat: '300078901200003',
  ...
  },
  {
    ...
    registeredName: 'Khalid Al-Otaibi Exports Inc.',
    email: 'khalid@otaibiexports.sa',
    phone: '+966 12 678 9012',
    customerVat: '300034567800003',
...
function CustomersList() {
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        enableSorting: true,
        cell: ({ getValue }) => (
          <span className="text-sm" dir="rtl">{getValue() || '-'}</span>
        ),
      },
      {
  ...
  const table = useReactTable({
    data: data.length > 0 ? data : sampleCustomers,
    columns,
          ...
          {isFilterOpen && (
            <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-[#161f30] rounded-lg border border-[#e7ebf3] dark:border-[#2a3447] shadow-lg z-20">
              <div className="p-4 space-y-4">
                <div>
                  <label className="text-xs font-bold text-[#4c669a] dark:text-gray-400 uppercase tracking-wider">Company Profile</label>
